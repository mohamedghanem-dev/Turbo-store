        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 gap-3">
            ...
            <Link
              ...
              aria-label="TurboStore Home"
            >
              <div className="w-8 h-8 bg-brand-gradient rounded-xl flex items-center justify-center shadow-brand-sm group-hover:scale-105 transition-transform">
                <svg className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
              </div>
              <span className="font-display text-lg font-bold text-slate-900 dark:text-white">
                Turbo<span className="text-brand-600">Store</span>
              </span>
            </Link>
            ...
            >
              <div className="relative w-full group">
                ...
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-brand-500 transition-colors pointer-events-none">
                ...
                <input
                  ...
                  className="
                    w-full pl-9 pr-24 py-2 text-sm
                    bg-slate-100 dark:bg-slate-800
                    border border-transparent
                    group-focus-within:border-brand-400 dark:group-focus-within:border-brand-600
                ...
                {searchQuery && (
                  <button
                    ...
                    className="absolute right-[4.5rem] top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors"
                  >
            ...
            <div className="flex items-center gap-1 sm:gap-1.5">
              ...
              <button
                ...
                aria-label="Search"
                className="lg:hidden w-9 h-9 flex items-center justify-center rounded-xl text-slate-500 dark:text-slate-400 hover:text-brand-600 dark:hover:text-brand-400 hover:bg-brand-50 dark:hover:bg-brand-950 transition-all"
              >
      ...
      <AnimatePresence>
        {isSearchOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-[60] flex items-start justify-center pt-16 px-4 bg-slate-900/60 backdrop-blur-sm"
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.2 }}
              className="w-full max-w-lg bg-white dark:bg-slate-800 rounded-2xl shadow-modal border border-slate-100 dark:border-slate-700 overflow-hidden"
              onClick={(e) => e.stopPropagation()}
            >
              <form onSubmit={handleSearch}>
                <div className="flex items-center gap-3 px-4 py-3 border-b border-slate-100 dark:border-slate-700">
                  <svg className="w-5 h-5 text-brand-500 shrink-0" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
                    <circle cx="11" cy="11" r="8" />
                    <path strokeLinecap="round" d="m21 21-4.35-4.35" />
                  </svg>
                  <input
                ...
                <div className="px-4 py-3 flex items-center justify-between">
                  ...
                  <button
                    type="submit"
                    className="flex items-center gap-1.5 px-4 py-2 bg-brand-600 hover:bg-brand-700 active:scale-95 text-white text-sm font-semibold rounded-xl transition-all duration-200"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                      <circle cx="11" cy="11" r="8" />
                      <path strokeLinecap="round" d="m21 21-4.35-4.35" />
